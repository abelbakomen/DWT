...
!
subroutine csv_write_integer( lun, value, sep, advance )
    integer, intent(in)   :: lun
    ...
    if ( advance ) then
       ...
       write(lun,'(a,a)',advance='no') trim(buffer), sep
    endif
end subroutine csv_write_integer

subroutine csv_write_real( lun, value, sep, advance )
    integer, intent(in)   :: lun
...
subroutine csv_write_dble( lun, value, sep, advance )
    integer, intent(in)                    :: lun
...
!     The value is written to the current record of the CSV-file
!
subroutine csv_write_char( lun, value, sep, advance )
    integer, intent(in)            :: lun
    ...
    if ( advance ) then
       ...
       write(lun,'(3a,a)',advance='no') '"',trim(buffer), '"', sep
    endif
...
!
subroutine csv_write_integer_1d( lun, array, sep, advance )
    integer, dimension(:), intent(in)   :: array

    include './csv/csv_file_1d.f90'

end subroutine csv_write_integer_1d

subroutine csv_write_real_1d( lun, array, sep, advance )
...
subroutine csv_write_dble_1d( lun, array, sep, advance )
...
subroutine csv_write_char_1d( lun, array, sep, advance )
...
!     the data type, we use an include file for the body.
!
subroutine csv_write_integer_2d( lun, array, sep )
    integer, dimension(:,:), intent(in)   :: array

    include './csv/csv_file_2d.f90'

end subroutine csv_write_integer_2d

subroutine csv_write_real_2d( lun, array, sep )
    real, dimension(:,:), intent(in)   :: array
...
subroutine csv_write_dble_2d( lun, array, sep )
    real(kind=kind(1.0d0)), dimension(:,:), intent(in)   :: array
...
subroutine csv_write_char_2d( lun, array, sep )
    character(len=*), dimension(:,:), intent(in)   :: array
